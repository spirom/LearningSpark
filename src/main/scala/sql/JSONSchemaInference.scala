...
object JSONSchemaInference {
  def main (args: Array[String]) {
    ...
    val ex1 = sqlContext.jsonFile("src/main/resources/data/inference1.json")
    ...
    val ex2 = sqlContext.jsonFile("src/main/resources/data/inference2.json")
    ...
    val ex3 = sqlContext.jsonFile("src/main/resources/data/inference3.json")
